...
const CARD_OPTIONS = [
  // hrs=每次免費時數；cap=每月可用次數(30≈天天/不限)；weekend=是否僅週末
  { bank: '台新', card: '環球無限卡', brands: ['utg', 'carmochi', 'dodohome', 'tps'], spend: 0, freeHr: '每日 4hr（每期80hr）', tier: 'premium', benefit: 'direct', hrs: 4, cap: 20 },
  { bank: '台新', card: '財富無限卡／尊爵世界卡', brands: ['utg', 'carmochi'], spend: 12000, freeHr: '每日 2hr（每期40hr）', tier: 'premium', benefit: 'direct', hrs: 2, cap: 20 },
  { bank: '台新', card: '御璽／鈦金卡', brands: ['utg'], spend: 12000, freeHr: '每日 2hr（每期10hr）', tier: 'general', benefit: 'direct', hrs: 2, cap: 5 },
  { bank: '中信', card: '一般指定卡（鼎極／商務）', brands: ['utg', 'carmochi', 'dodohome', 'tps', 'parkinsys'], spend: 20000, freeHr: '每日 2hr（月10次）', tier: 'general', benefit: 'direct', hrs: 2, cap: 10 },
  { bank: '中信', card: 'LEXUS 商務世界卡', brands: ['utg', 'carmochi', 'dodohome', 'tps', 'parkinsys'], spend: 20000, freeHr: '聯通每日 4hr（月不限）', tier: 'premium', benefit: 'direct', hrs: 4, cap: 30 },
  { bank: '國泰世華', card: '一般信用卡（小樹點折抵）', brands: ['utg', 'dodohome', 'tps', 'vivipark', 'parkinsys'], spend: 0, freeHr: '每日 3hr', tier: 'general', benefit: 'points', hrs: 3, cap: 30 },
  { bank: '國泰世華', card: '世界卡', brands: ['utg', 'dodohome'], spend: 0, freeHr: '每日 3hr（20點/hr）', tier: 'premium', benefit: 'points', hrs: 3, cap: 30 },
  { bank: '玉山', card: 'Unicard（紅利折抵）', brands: ['dodohome', 'tps'], spend: 0, freeHr: '每次最高 3hr（40點/hr）', tier: 'general', benefit: 'points', hrs: 3, cap: 30 },
  { bank: '玉山', card: '世界卡／無限卡（滿額）', brands: ['utg', 'dodohome', 'tps'], spend: 5000, freeHr: '每日 2hr', tier: 'premium', benefit: 'direct', hrs: 2, cap: 30 },
  { bank: '富邦', card: '鈦金／富利生活鈦金卡', brands: ['utg', 'dodohome'], spend: 0, freeHr: '每日 1hr（月10次）', tier: 'general', benefit: 'points', hrs: 1, cap: 10 },
  { bank: '富邦', card: '尊御世界卡', brands: ['utg', 'dodohome'], spend: 10000, freeHr: '每日 3hr（月10次）', tier: 'premium', benefit: 'points', hrs: 3, cap: 10 },
  { bank: '聯邦', card: '珍鑽／大立無限卡', brands: ['utg', 'carmochi', 'dodohome', 'vivipark', 'parkinsys'], spend: 0, freeHr: '每日 2hr（月不限）', tier: 'premium', benefit: 'direct', hrs: 2, cap: 30 },
  { bank: '聯邦', card: '全國加油／樂活御璽鈦金卡', brands: ['utg', 'carmochi', 'dodohome', 'vivipark', 'parkinsys'], spend: 12000, freeHr: '每日 2hr（月5次）', tier: 'general', benefit: 'direct', hrs: 2, cap: 5 },
  { bank: '上海商銀', card: '世界商務卡等', brands: ['utg', 'carmochi', 'dodohome', 'vivipark'], spend: 10000, freeHr: '每日 3hr（月5次）', tier: 'premium', benefit: 'direct', hrs: 3, cap: 5 },
  { bank: '上海商銀', card: '紅利折抵（全卡友）', brands: ['utg', 'carmochi', 'dodohome', 'vivipark'], spend: 0, freeHr: '每日 2hr（600點/hr）', tier: 'general', benefit: 'points', hrs: 2, cap: 30 },
  { bank: '兆豐', card: '無限卡／世界卡', brands: ['utg', 'carmochi', 'dodohome', 'vivipark'], spend: 0, freeHr: '每日 3hr（300點/hr）', tier: 'premium', benefit: 'points', hrs: 3, cap: 30 },
  { bank: '兆豐', card: '個人商旅卡 Plus', brands: ['utg', 'carmochi', 'dodohome', 'vivipark'], spend: 0, freeHr: '每日 3hr', tier: 'general', benefit: 'points', hrs: 3, cap: 30 },
  { bank: '星展', card: 'everyday 鈦金卡', brands: ['utg'], spend: 20000, freeHr: '天天 2hr', tier: 'general', benefit: 'direct', hrs: 2, cap: 30, note: '僅台灣聯通' },
  { bank: '星展', card: '極耀無限卡', brands: ['utg', 'dodohome'], spend: 20000, freeHr: '週末 4hr', tier: 'premium', benefit: 'direct', hrs: 4, cap: 8, weekend: true, note: '限週六日' },
  { bank: '永豐', card: '財富無限卡／永豐世界卡', brands: ['utg', 'dodohome'], spend: 10000, freeHr: '每日 2hr（月10次）', tier: 'premium', benefit: 'direct', hrs: 2, cap: 10 },
  { bank: '永豐', card: '永傳世界卡', brands: ['utg', 'dodohome'], spend: 10000, freeHr: '每日 4hr（月30次）', tier: 'premium', benefit: 'direct', hrs: 4, cap: 30 },
  { bank: '第一銀行', card: '鈦金／御璽卡', brands: ['utg', 'dodohome', 'tps', 'vivipark'], spend: 20000, freeHr: '每日 2hr（月10次）', tier: 'general', benefit: 'direct', hrs: 2, cap: 10 },
  { bank: '第一銀行', card: 'Glory+ 世界卡', brands: ['utg', 'dodohome', 'tps', 'vivipark'], spend: 0, freeHr: '每日 2hr（月20次）', tier: 'premium', benefit: 'direct', hrs: 2, cap: 20, note: '高資產客戶' },
  { bank: '華南', card: '領航極致尊榮卡', brands: ['utg', 'dodohome', 'tps', 'vivipark'], spend: 3000, freeHr: '每日 3hr（月10次）', tier: 'premium', benefit: 'direct', hrs: 3, cap: 10 },
  { bank: '華南', card: '領航尊榮卡／The ONE', brands: ['utg', 'dodohome', 'tps', 'vivipark'], spend: 15000, freeHr: '每日 2hr（月6次）', tier: 'premium', benefit: 'direct', hrs: 2, cap: 6 },
  { bank: '合庫', card: '無限卡／金鑽卡', brands: ['utg', 'dodohome', 'tps', 'vivipark'], spend: 10000, freeHr: '每日 3hr（月15次）', tier: 'premium', benefit: 'direct', hrs: 3, cap: 15 },
];
{
  ...
  const dataJson = JSON.stringify({
    cards: CARD_OPTIONS.map(({ bank, card, spend, freeHr, tier, benefit, note, hrs, cap, weekend }) => ({ bank, card, spend, freeHr, tier, benefit, note: note || '', hrs: hrs || 0, cap: cap || 30, weekend: !!weekend })),
    cov,
  });
  ...
  const QUIZ_JS = '(function(){var D=JSON.parse(document.getElementById("q-data").textContent);var g=function(i){return document.getElementById(i);};'
    ...
    + 'function run(){var area=g("q-area").value,sp=g("q-spend").value,ti=g("q-tier").value,fq=g("q-freq").value;'
    + 'var maxSpend=sp==="lt1"?9999:sp==="1to2"?19999:1e12;var need=fq==="heavy"?6:1;var cv=D.cov[area],total=cv.t,L=[];'
    + 'function fit(cd){return cd.weekend?0:(cd.cap>=need?2:1);}'
    ...
    + 'L.sort(function(a,b){return b.n-a.n||fit(b.cd)-fit(a.cd)||b.cd.hrs-a.cd.hrs||bR[a.cd.benefit]-bR[b.cd.benefit]||a.cd.spend-b.cd.spend||tR[a.cd.tier]-tR[b.cd.tier];});'
    ...
    + 'var wn=cd.weekend?"⚠️ 僅限週六日，平日無法使用":(cd.cap<need?"⚠️ 每月約 "+cd.cap+" 次，常停可能不夠":"");'
    ...
    + '+(wn?"<div class=\\"meta\\" style=\\"color:#c0392b\\">"+wn+"</div>":"")'
    ...
    + 'o+="<p style=\\"margin-top:8px\\">💡 排序邏輯：先看該區<b>涵蓋站數</b>，再看是否<b>符合你的停車頻率</b>（避開每月次數少、只限週末的卡），接著<b>免費時數多者優先</b>、<b>直接免費</b>（不花紅利點數）優先。頂級卡（無限卡/世界卡等）通常有年費、需財力、可能為邀請制，實際核卡與優惠以各發卡行公告為準。</p>";'
...
<label>④ 你多常需要停車優惠？<select id="q-freq"><option value="light">偶爾（每月 5 次內）</option><option value="heavy">經常（每月 6 次以上）</option></select><span style="font-weight:400;font-size:12px;color:var(--muted)">有些卡覆蓋度高，但每月有次數上限、或只限週末；常停的人會幫你把這些往後排。</span></label>
...
<script>${QUIZ_JS}</script>`;
  write('parking/選卡/index.html', page({
    title: '停車信用卡推薦｜4 題幫你選對卡（13 家比較）｜小Ｐ帶路',
    description: '回答 4 題（常停哪區、每月刷卡、卡等級、停車頻率），依覆蓋度＋免費時數幫你選信用卡市區停車優惠，附 13 家銀行比較表。',
    canonical: PICK, appHref: APP('seo'), builtAt,
    crumb: `<a href="${APP('seo')}">小Ｐ帶路</a> › <a href="${HUB}">全台</a> › 停車信用卡怎麼選`,
    h1: '停車信用卡怎麼選？4 題幫你挑對卡',
    lead: '先選你常停的地區，再依刷卡額、卡等級與停車頻率，幫你排出「涵蓋度最高、免費時數多、你又真的用得到」的信用卡停車優惠。',
    body,
